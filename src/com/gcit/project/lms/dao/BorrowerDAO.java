...
public class BorrowerDAO extends BaseDAO<Borrower> {
	...
	public List<Book> viewAvailableBooks(int branchId) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
	...
	public void checkoutBook(int branchId, int bookId) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		//TODO: Interesting Thing About the Schema Of Database - Does noOfCopies mean total copies or number of copies available currently
	...
	public void returnBook(int branchId, int bookId) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		String sql = "update tbl_book_copies set noOfCopies = (noOfCopies + 1) where branchId = ? and bookId = ?";
		PreparedStatement pstmt = conn.prepareStatement(sql);
		pstmt.setObject(1, branchId);
		pstmt.setObject(2, bookId);
	...
	public void updateDueDate(int branchId, int bookId, int cardNo) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
	...
	public void updateCheckIn(int branchId, int bookId, int cardNo) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
	...
	public Borrower readBorrowerByPK(Integer pk) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
